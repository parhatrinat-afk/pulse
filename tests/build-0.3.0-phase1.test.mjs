...
test("Office Script validation keeps dynamic Mapping lists same-sheet and small lists literal", () => {
  ...
  assert.match(validationBody, /applyRangeValidation\(sheet\.getRange\("B10"\), sheet\.getRange\("AV2:AV3"\)/);
  ...
  assert.match(validationBody, /applyLiteralValidation\(sheet\.getRange\("A23:A172"\)/);
